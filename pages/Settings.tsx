    ...
    <div className="max-w-5xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 space-y-6 md:space-y-0">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex items-center justify-center px-8 py-4 border-2 border-indigo-300 bg-indigo-50 text-indigo-600 rounded-[1.5rem] font-black hover:bg-indigo-100 transition-all active:scale-95 disabled:opacity-50 uppercase tracking-widest text-xs"
        >
          {saving ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <aside className="space-y-8">
          <div className="bg-gradient-to-br from-indigo-50 to-blue-50 p-8 rounded-[2.5rem] border border-indigo-100">
            <h3 className="text-lg font-black mb-4 flex items-center text-indigo-700">
